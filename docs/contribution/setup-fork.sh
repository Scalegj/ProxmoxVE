...
# upstream   https://github.com/Scalegj/ProxmoxVE.git (fetch)
# upstream   https://github.com/Scalegj/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/Scalegj/ProxmoxVE"
echo ""
